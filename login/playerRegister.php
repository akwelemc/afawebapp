...
<body>
    <section>
        ...
        <div class = "contentBx">
            <div class = "formBx">
                <h2>Register Page</h2> 
                <form action="../action/register_action.php" onsubmit= "return validateForm(event)" class="form" id="register" method="post">
                    <div class = "inputBx">
                        <span>Name</span>
                    ...
                    <div class = "inputBx">
                        <span>Height</span>
                        <input type = "height" id="height" name="height" placeholder="Please enter your height" required>
                    </div>

                    <div class = "inputBx">
                        <span>Weight</span>
                        <input type = "weight" id="height" name="weight" placeholder="Please enter your weight" required>
                    </div>

                    <div class = "inputBx">
                        <span>Position</span>
                        <input type = "Position" id="position" name="position" placeholder="Please enter your position" required>
                    </div>
                    ...
                    <div class = "inputBx">
                        <p>Already have an account? <a href = "../login/playerLogin.php">Sign In!</a></p>
                    </div>
                </form>    
            </div>
        </div>
