...
<body>
    <section>
        ...
        <div class = "contentBx">
            <div class = "formBx">
                <h2>Login Page</h2> 
                <form action="../action/login_action.php" onsubmit= "validateForm(event)" class="form" id="login" method="post" >
                    <div class = "inputBx">
                        <span>Username</span>
                    ...
                    <div class = "inputBx">
                        <p>Don't have an account? <a href = "../login/playerRegister.php">Register!</a></p>
                    </div>
                </form>    
            </div>
        </div>
