...
<body>
    <section>
        ...
        <div class = "contentBx">
            <div class = "formBx">
                <h2>Login Page</h2> 
                <form action="../action/coach_login_action.php" onsubmit= "validateForm(event)" class="form" id="login" method="post" >
                    <div class = "inputBx">
                        <span>Username</span>
                    ...
                    <div class = "inputBx">
                        <p>Don't have an account? <a href = "../login/coachRegister.php">Register!</a></p>
                    </div>
                </form>    
            </div>
        </div>
